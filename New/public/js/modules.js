    ...
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $('.prompt').myPrompt({
          ...
          value: username+" will no longer be able to follow, message, comment, recommend or add you in any group. Students Connect won't let "+ username+" know you blocked him/her. You can unblock from settings.",
          doneText: "Block",
          type: "block_user",
          post: $(this)
        });
