...
<html>
  <head>
    ...
    <meta name="author" content="Students Connect, Marlou Rentucan">
    <link rel="shortcut icon" href="Frontpage/assets/img/favicon.png" type="image/png">
  ...
  <body>
    ...
    <div class="index_header">
      <div class="logo">
        <img src="Frontpage/assets/img/favicon.png" alt="">
        <hr>
        <!-- <img src="images/needs/Snap 2017-01-29 at 18.32.04.jpg" alt=""> -->
        <span>Students Connect</span>
      </div>
      <div class="right">
