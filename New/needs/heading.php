...
<body>
  <div class="header">
    <div class="logo">
      <a href="<?php echo DIR; ?>"><img src="../assets/img/favicon.png" alt="Students Connect"></a>
    </div>
    <div class="search_box">
      <?php if($universal->isLoggedIn()){ ?>
      <input type="text" name="" placeholder="Search Notes, Subjects etc." spellcheck="false" autocomplete="off" class="search" autofocus>
  ...
  <?php if($universal->isLoggedInAdmin()){ ?>
    <a href="<?php echo DIR; ?>/notifications2.php" class="notification">
      <span class="notification_span2"><i class='material-icons'>miscellaneous_services</i>
      </span>
      <span class="links_span">&nbsp Administrative Dashboard</span>
    </a>
