...
<?php
  $title = "{$noti->titleNoti()} @{$universal->GETsDetails($get_id, "username")} ({$universal->GETsDetails($get_id, "firstname")} {$universal->GETsDetails($get_id, "surname")}) • Students Connect";
  $keywords = "{$universal->GETsDetails($get_id, "username")}, {$universal->GETsDetails($get_id, "firstname")}, {$universal->GETsDetails($get_id, "surname")}, Students Connect, Share and capture Notes!";
  $desc = "Connect with {$universal->GETsDetails($get_id, "username")}'s profile • Students Connect";
?>
