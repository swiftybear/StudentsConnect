...
<?php
  $title = "{$noti->titleNoti()} Member not found • Students Connect";
  $keywords = "eror, 404, document not found, webpage not found, Students Connect, Share and capture Notes!";
  $desc = "There's been an error • Students Connect";
?>
