  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Team Students Connect');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Team Students Conenct');
        ...
        $mail->Subject = 'Activate your Students Connect account';

        $mail->Body = "<span>Hello, You received this message because you created an account on Students Connect.<span><br>
        <span>Click on button below to retrieve your Students Connect account and explore.</span><br><br>
