...
<div class="i_p_main p_main">
  <div class="i_p_ta">
    <textarea name="name" placeholder="Share your notes, Ask help etc., @<?php echo $universal->GETsDetails($session, "username"); ?>? #study" spellcheck="false" class="t_p_ta"></textarea>
  </div>
  <div class="link_p_o">
