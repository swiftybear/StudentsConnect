<div class="senapati">
  ...
  <div class="prajkumar">
    ...
    <div class="post_it inst">
      ...
      <div class="post_teaser">
        <span class="p_whats_new user_whats_new" data-when='user'>Share your notes, Ask help etc., @<?php echo $universal->nameShortener($universal->getUsernameFromSession(), 20); ?>? #study</span>
  ...
  <div class="srajkumar home_rajkumar">
    ...
    <div class="c_g_div inst">
      <span>Create public or private group of your interest subjects with people you know.</span>
