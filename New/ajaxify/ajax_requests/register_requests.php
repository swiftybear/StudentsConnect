<?php
  ...
  if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    if (isset($_POST['username']) && isset($_POST['firstname']) && isset($_POST['surname']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['terms']) && isset($_POST['department'])) {
      ...
      $department =  trim(preg_replace("#[<> ]#i", '', $_POST['department']));

      echo $login->REGISTER($username, $firstname, $surname, $email, $password, $pri_ip, $department);
