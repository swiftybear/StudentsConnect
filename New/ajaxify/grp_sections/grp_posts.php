...
<div class="senapati pro_senapati a_m_senapti">
  ...
  <div class="srajkumar grp_srajkumar">
    ...
    <div class="c_g_div inst">
      <span>You can create a public or private group of your interest subjects with people you know by clicking on the options.</span>
      <div class="grp_c_we">
    ...
    <div class="c_g_div inst">
      <span>Explore more groups from all around Students Connect.</span>
      <div class="grp_c_we">
  ...
  <div class="prajkumar a_m_prajkumar">
    ...
    <div class="post_it inst">
      ...
      <div class="post_teaser">
        <span class="p_whats_new grp_whats_new" data-grp='<?php echo $grp; ?>' data-when='group'>Share your notes, Ask help etc., @<?php echo $universal->nameShortener($universal->getUsernameFromSession(), 20); ?>? #study</span>
