  ...
  <div class="about">
    ...
    <div class="sabout">
      ...
      <div class="sabout_one inst">
        ...
        <div class="sabout_one_info">
          <span>Update or edit you profile to make it look more professional. </span>
    ...
    <div class="fabout">
      ...
      <div class="a_instagram">
        <span class="a_label">Students Connect</span>
        <?php
          if($universal->GETsDetails($get_id, "instagram") == ""){
            if ($universal->MeOrNot($get_id)) {
        ?>
              <a href="<?php echo DIR; ?>/edit">Add Students Connect account</a>
        <?php
            }
          } else {
        ?>
